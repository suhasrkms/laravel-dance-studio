...
@section('content')
  ...
  <section id="intro">
    <div class="intro-container">
      <div id="introCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <a href="#about" class="mouse-hover scrollto"><div class="mouse"></div></a>
        </div>
      </div>
    </div>
    ...
    <main id="main">
      ...
      <section id="about">
        <div class="container">
          <div class="d-flex align-items-center p-3 my-3 text-white-50 rounded shadow-sm" style="background-color: #6f42c1; box-shadow:5px 5px 10px;">
